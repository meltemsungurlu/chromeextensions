...
chrome.runtime.onMessage.addListener( (message, sender, sendResponse) => {
    ...
    if(message.type === 'phone-message'   ){
        
        let /** @type {messageRequest}*/ request = message.detail;
        sendMessageType(request);
   
        
           sendResponse({
               success:true,
               message: "Phone number received ans processed:" + request.recipient,
           });
       return true;
    }
