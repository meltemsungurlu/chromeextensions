...
const ca={
  ...
  ca.chrome.api.whatsApp.collectGroupMembers = function(membersArr) {
  ...
  ca.chrome.api.whatsApp.iterateUsers = function(callBack) {
...
let collectUnknownNumbers_Old = function(callBack) {
  ...
  ca.chrome.api.whatsApp.sendMessage = function(message) {
    ...
    //CHROME 
  ca.chrome.api.whatsApp.makeWinShortcut = function(phone, name, more, isTel = false) {
    name = name || 'Untitled';
    more = more || '';
    var wPhone = phone.replace(/[^\d]/g, '');
...
`;
 ...
 ca.chrome.api.whatsApp.getProfileUrl = function(phone) {
  ...
  ca.chrome.api.whatsApp.makeShortcut = function(label) {
    // console.clear();
...
window.csvStack = [];
 ...
 ca.chrome.api.whatsApp.parseMemberInfo = function() {
 ...
 ca.chrome.api.whatsApp.makeShortcuts = () => {
   ...
   ca.chrome.api.whatsApp.collectUnknownNumbers=function(filter) {
...
// })
 ...
 ca.chrome.api.whatsApp.parseContactInfo = function() {
...
var panelControl;
 ca.chrome.api.whatsApp.collectWupGroupMembers = function() {
...
`)
 ...
 ca.chrome.api.whatsApp.formatNames = function(container) {
    var fmtArr = [];
