...
( function renderPopUp () {
    ...
    if ( !b.querySelector( '#' + popUpId ) )
    {
        ...
        ${ selector } {
            ...
            box-shadow: gainsboro 0px 2px 5px 2px;
            border-radius: 5px;
            padding: 4px;
            z-index: 10000;
        ...
        let numCell = _$( 'div' ).cls( 'h' ).addTo( numRow );
        ...
        let okBtn = _$( 'i' ).cls( 'icon-ok' ).addTo( cmdRow );
        let paused=false;
        let cache;
        ...
        okBtn.addEventListener( 'click', ( e ) => {
            let messageRequest = {
                ...
                recipient: numCell.textContent,
                message: textBox.value,

            }

            let request=new runTimeRequest("phone-message",messageRequest);
        ...
        b.addEventListener( 'mouseover', ( e ) => {
            if ( popUp.contains( e.target )   ) return false;
            ...
            if ( text.length < 100 )
            {
                ...
                if ( length >= 10 && length < 13 && cache !==phone)
                {

                    numCell.textContent = phone;
