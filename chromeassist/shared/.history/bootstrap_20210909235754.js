...
class utility {
    ...
    static injectSharedStyle2() {
        ...
        if (!styleLoaded) {
            let getUrl=(ref) => {
                return chrome.extension.getURL(ref) 
            }
...
@font-face {
    ...
    font-style: normal;
    font-weight: 400;
    src: url(/common/styles/fonts/materials/MaterialIcons-Regular.eot);
    /* For IE6-8 */
    src: local('Material Icons'), local('MaterialIcons-Regular'), 
    url(/common/styles/fonts/materials/MaterialIcons-Regular.woff2) format('woff2'), 
    url(/common/styles/fonts/materials/MaterialIcons-Regular.woff) format('woff'), 
    url(/common/styles/fonts/materials/MaterialIcons-Regular.ttf) format('truetype');
}
